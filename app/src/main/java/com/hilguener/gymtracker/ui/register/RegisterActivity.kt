package com.hilguener.gymtracker.ui.register
...
import com.hilguener.gymtracker.ui.login.LoginActivity
import com.hilguener.gymtracker.ui.login.LoginScreen
...
fun RegisterScreen(modifier: Modifier = Modifier) {
    ...
    Scaffold(modifier = modifier.padding(36.dp)) {
        Column(
            ...
            RegisterEmailField()
            Spacer(modifier = Modifier.height(16.dp))
            RegisterPasswordField("Enter Password")
            Spacer(modifier = Modifier.height(16.dp))
...
@Composable
fun RegisterPasswordField(text: String) {
